...
const plans = [
  { id: 1, title: 'Overcoming Anxiety', duration: '7 Days', icon: '🍃', color: '#424939', description: 'Breathing techniques & grounding exercises' },
  { id: 2, title: 'Better Sleep', duration: '14 Days', icon: '🌙', color: '#6A5B5B', description: 'Wind-down routines & sleep hygiene habits' },
  { id: 3, title: 'Building Confidence', duration: '21 Days', icon: '⭐', color: '#8B4E3D', description: 'Daily affirmations & mindset reframing' },
  { id: 4, title: 'Stress Management', duration: '10 Days', icon: '🧘', color: '#261A1A', description: 'Mindfulness practices & relaxation tools' },
];
...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { fontSize: 15, color: '#4E4444', marginBottom: 24, lineHeight: 22 },
  ...
  icon: { fontSize: 26 },
  planInfo: { flex: 1 },
  planTitle: { fontSize: 17, fontWeight: '800', color: '#1C1C18', marginBottom: 3, letterSpacing: -0.2 },
  planDescription: { fontSize: 13, color: '#807474', fontWeight: '500', marginBottom: 8 },
  durationChip: { alignSelf: 'flex-start', backgroundColor: '#F0EEE8', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
